        ...
        <tr>
            ...
            <%
                    ...
                    if (action != null && action.equals("insert")) {
						...
						pstmt.setInt(2, Integer.parseInt(request.getParameter("health_id")));
            ...
            <%
                    ...
                    ResultSet rs = statement.executeQuery("SELECT * FROM insured");
            %>
                ...
                <table border="1">
                    ...
                    <tr>
                        <form action="insured.jsp" method="get">
                            <input type="hidden" value="insert" name="action">
                            <th><input value="" name="sid" size="10"></th>
							<th><input value="" name="health_id" size="10"></th>
            ...
            %>
                    ...
                    <tr>
                        <form action="insured.jsp" method="get">
							...
							<td>
                                <input value="<%= rs.getInt("health_id") %>" 
                                    name="health_id" size="10">
                            </td>
