    ...
    <table border="1">
        <tr>
            ...
            <%
                    ...
                    if (action != null && action.equals("insert")) {
                        ...
                        PreparedStatement pstmt = conn.prepareStatement(
                            "INSERT INTO other_department_thesis VALUES (?, ?, ?)");
            ...
            <%
                    ...
                    ResultSet rs = statement.executeQuery("SELECT * FROM other_department_thesis");
            %>
                ...
                <table border="1">
                    ...
                    <tr>
                        <form action="other_dept_thesis.jsp" method="get">
            ...
            %>
                    ...
                    <tr>
                        ...
                        <form action="other_department_thesis.jsp" method="get">
