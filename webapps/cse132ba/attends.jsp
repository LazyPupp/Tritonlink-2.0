        ...
        <tr>
            ...
            <%
                    ...
                    if (action != null && action.equals("insert")) {
						...
						pstmt.setInt(2, Integer.parseInt(request.getParameter("time_id")));
            ...
            <%
                    ...
                    ResultSet rs = statement.executeQuery("SELECT * FROM Attends");
            %>
                ...
                <table border="1">
                    ...
                    <tr>
                        <form action="attends.jsp" method="get">
                            <input type="hidden" value="insert" name="action">
                            <th><input value="" name="sid" size="10"></th>
							<th><input value="" name="time_id" size="10"></th>
